...
| ✅ | Can users view, edit, and delete their own personal data via their account? <br>*Note: Specification supports viewing/editing bookings; administrator deletion enables right to be forgotten.* |
